...
System::System(const string &strVocFile, const string &strSettingsFile,
  ...
  mpPointCloudMapping =
      make_shared<PointCloudMapping>(resolution, meank, thresh);
  ...
  mpTracker = new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer,
                           mpMap, mpPointCloudMapping, mpKeyFrameDatabase,
...
void System::save() { mpPointCloudMapping->Save(); }
int System::getloopcount() { return mpLoopCloser->loopcount; }
}  // namespace ORB_SLAM2
